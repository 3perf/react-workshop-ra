...
class ApplicationApi extends Api {
  ...
  static fetchApplication(
    ...
    return Promise.resolve({
      ...
      config: {},
      "responseMeta":{"status":200,"success":true},"data":{"id":"6133780827f57a3fce2d1e45","userPermissions":["manage:applications","read:applications","publish:applications","makePublic:applications"],"name":"Next.js issues","organizationId":"60b0137977bd5c1e8d9f276c","isPublic":false,"pages":[{"id":"6133780827f57a3fce2d1e47","isDefault":true,"default":true}],"appIsExample":false,"color":"#E9C951","icon":"alien","new":false}
    }) as any;
  }
