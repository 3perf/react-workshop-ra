...
class UserApi extends Api {
  ...
  static getCurrentUser(): AxiosPromise<ApiResponse> {
    return Promise.resolve({
      ...
      config: {},
      "responseMeta":{"status":200,"success":true},"data":{"userPermissions":[],"email":"ivan@3perf.com","source":"FORM","isEnabled":true,"currentOrganizationId":"60b0137977bd5c1e8d9f276c","organizationIds":["60b0137977bd5c1e8d9f276c"],"groupIds":[],"permissions":[],"isAnonymous":false,"enabled":true,"username":"ivan@3perf.com","accountNonExpired":true,"accountNonLocked":true,"credentialsNonExpired":true,"claims":{},"address":{},"new":true}
    }) as any;
  }
